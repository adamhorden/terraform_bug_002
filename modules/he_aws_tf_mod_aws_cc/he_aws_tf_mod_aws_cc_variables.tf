...
# var.he_aws_tf_mod_aws_cc_he_aws_tf_mod

variable he_aws_tf_mod_aws_cc_he_aws_tf_mod {
              ...
              he_aws_tf_mod_aws_cc = object(
                {
                  aws_codecommit_repository = object(
                    {
                      aws_codecommit_repository = list(
                        object(
                          {
                            app_env = string
                          }
                  ...
                  aws_codecommit_trigger = object(
                    {
                      aws_codecommit_trigger = list(
                        object(
                          {
                            app_env = string
                          }
